...
func (o *UpdateEndpointRequest) GetEmailTemplate() []UpdateEndpointRequestEmailTemplateInner {
	if o == nil || IsNil(o.EmailTemplate) {
		var ret []UpdateEndpointRequestEmailTemplateInner
		return ret
	}
...
// SetEmailTemplate gets a reference to the given []UpdateEndpointRequestEmailTemplateInner and assigns it to the EmailTemplate field.
