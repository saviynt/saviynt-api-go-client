...
type ApiDeleteKeyStoreAliasAliasRequest struct {
	ctx context.Context
	ApiService *MTLSAuthenticationAPIService
	alias string
}

func (r ApiDeleteKeyStoreAliasAliasRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteKeyStoreAliasAliasExecute(r)
}

/*
DeleteKeyStoreAliasAlias Delete KeyStore
...
Note: Ensure that you have specified the name of the alias in the request URL.
 ...
 @param alias
 @return ApiDeleteKeyStoreAliasAliasRequest
*/
func (a *MTLSAuthenticationAPIService) DeleteKeyStoreAliasAlias(ctx context.Context, alias string) ApiDeleteKeyStoreAliasAliasRequest {
	return ApiDeleteKeyStoreAliasAliasRequest{
		ApiService: a,
		ctx: ctx,
		alias: alias,
...
func (a *MTLSAuthenticationAPIService) DeleteKeyStoreAliasAliasExecute(r ApiDeleteKeyStoreAliasAliasRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MTLSAuthenticationAPIService.DeleteKeyStoreAliasAlias")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/deleteKeyStoreAlias/{alias}"
...
func (a *MTLSAuthenticationAPIService) GetKeyStoreCertificateDetailsExecute(r ApiGetKeyStoreCertificateDetailsRequest) (*GetKeyStoreCertificateDetailsResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/getKeyStoreCertificateDetails"
...
func (r ApiUploadKeyStoreRequest) KeyStoreFile(keyStoreFile string) ApiUploadKeyStoreRequest {
...
func (a *MTLSAuthenticationAPIService) UploadKeyStoreExecute(r ApiUploadKeyStoreRequest) (*UploadKeyStoreResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/uploadKeyStore"
	...
	if r.keyStoreFile != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "keyStoreFile", r.keyStoreFile, "", "")
	}
