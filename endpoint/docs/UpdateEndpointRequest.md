...
------------ | ------------- | ------------- | -------------
**Endpointname** | **string** | The name of the endpoint to be updated. | 
**DisplayName** | Pointer to **string** | The display name for the endpoint. | [optional] 
**Securitysystem** | Pointer to **string** | The security system to which the endpoint will belong. | [optional] 
...
**ResourceOwner** | Pointer to **string** |  | [optional] 
...
**CreateEntTaskforRemoveAccEnd** | Pointer to **string** | If access entitlements are created | [optional] 
...
**ChangePasswordAccessQuery** | Pointer to **string** | Query to restrict the access for changing the account password of the endpoint | [optional] 
