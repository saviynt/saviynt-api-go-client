...
------------ | ------------- | ------------- | -------------
**Endpointname** | **string** | The name of the endpoint to be created. | 
**DisplayName** | **string** | The display name for the endpoint. | 
**Securitysystem** | **string** | The security system to which the endpoint will belong. | 
...
**Owner** | Pointer to **string** | Owner of the endpoint. | [optional] 
**ResourceOwnerType** | Pointer to **string** | Type of resource owner (e.g., Usergroup). | [optional] 
**ResourceOwner** | Pointer to **string** | Resource owner for the endpoint | [optional] 
**Accessquery** | Pointer to **string** | Access query for the endpoint. | [optional] 
**EnableCopyAccess** | Pointer to **string** | Whether to enable copy access. | [optional] 
**DisableNewAccountRequestIfAccountExists** | Pointer to **string** | Whether to disable new account requests if an account already exists. | [optional] 
**DisableRemoveAccount** | Pointer to **string** | Whether to disable account removal. | [optional] 
**DisableModifyAccount** | Pointer to **string** | Whether to disable account modifications. | [optional] 
**UserAccountCorrelationRule** | Pointer to **string** | Rule to map users in EIC with the accounts during account import | [optional] 
...
**Connectionconfig** | Pointer to **string** | Connection Configuration is related to processing the add access tasks and remove access tasks related to AD and LDAP Connectors. | [optional] 
**Requestable** | Pointer to **string** | Is this endpoint requestable | [optional] 
**ParentAccountPattern** | Pointer to **string** | Specify the parent and child relationship for the Active Directory endpoint | [optional] 
...
**BlockInflightRequest** | Pointer to **string** | To allow if users can raise duplicate requests for the same applications | [optional] 
**AccountNameRule** | Pointer to **string** | Rule to generate an account name for this endpoint while creating a new account | [optional] 
...
**Customproperty1Label** | Pointer to **string** |  | [optional] 
**Customproperty2Label** | Pointer to **string** |  | [optional] 
**Customproperty3Label** | Pointer to **string** |  | [optional] 
**Customproperty4Label** | Pointer to **string** |  | [optional] 
**Customproperty5Label** | Pointer to **string** |  | [optional] 
**Customproperty6Label** | Pointer to **string** |  | [optional] 
**Customproperty7Label** | Pointer to **string** |  | [optional] 
**Customproperty8Label** | Pointer to **string** |  | [optional] 
**Customproperty9Label** | Pointer to **string** |  | [optional] 
**Customproperty10Label** | Pointer to **string** |  | [optional] 
**Customproperty11Label** | Pointer to **string** |  | [optional] 
**Customproperty12Label** | Pointer to **string** |  | [optional] 
**Customproperty13Label** | Pointer to **string** |  | [optional] 
**Customproperty14Label** | Pointer to **string** |  | [optional] 
**Customproperty15Label** | Pointer to **string** |  | [optional] 
**Customproperty16Label** | Pointer to **string** |  | [optional] 
**Customproperty17Label** | Pointer to **string** |  | [optional] 
**Customproperty18Label** | Pointer to **string** |  | [optional] 
**Customproperty19Label** | Pointer to **string** |  | [optional] 
**Customproperty20Label** | Pointer to **string** |  | [optional] 
**Customproperty21Label** | Pointer to **string** |  | [optional] 
**Customproperty22Label** | Pointer to **string** |  | [optional] 
**Customproperty23Label** | Pointer to **string** |  | [optional] 
**Customproperty24Label** | Pointer to **string** |  | [optional] 
**Customproperty25Label** | Pointer to **string** |  | [optional] 
**Customproperty26Label** | Pointer to **string** |  | [optional] 
**Customproperty27Label** | Pointer to **string** |  | [optional] 
**Customproperty28Label** | Pointer to **string** |  | [optional] 
**Customproperty29Label** | Pointer to **string** |  | [optional] 
**Customproperty30Label** | Pointer to **string** |  | [optional] 
...
**ChangePasswordAccessQuery** | Pointer to **string** | Specify query to restrict the access for changing the account password | [optional] 
