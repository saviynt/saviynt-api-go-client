...
------------ | ------------- | ------------- | -------------
**Endpointname** | Pointer to **string** | The name of the endpoint | [optional] 
**DisplayName** | Pointer to **string** | The display name for the endpoint. | [optional] 
**ConnectionType** | Pointer to **string** | Endpoints under security systems mapped to the connections of this connection type | [optional] 
