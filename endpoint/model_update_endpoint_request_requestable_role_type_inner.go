...
type UpdateEndpointRequestRequestableRoleTypeInner struct {
	// Type of role (e.g., Application, Enterprise, Enabler, Transactional, EmergencyAccess)
	RoleType *string `json:"roleType,omitempty"`
	// How roles are displayed (e.g., None, DropDownSingle, Table, TableOnlyAdd)
	RequestOption *string `json:"requestOption,omitempty"`
	// Whether role selection is required
	Required *bool `json:"required,omitempty"`
	// Query for filtering requested roles
	RequestedQuery *string `json:"requestedQuery,omitempty"`
	// Query for filtering selected roles
	SelectedQuery *string `json:"selectedQuery,omitempty"`
	// Specifies where to display roles (e.g., All, ShowOnApplicationRequest, ShowOnServiceAccountRequest)
