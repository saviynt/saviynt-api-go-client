...
// checks if the ExportAccountRequestAdvsearchcriteria type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExportAccountRequestAdvsearchcriteria{}

// ExportAccountRequestAdvsearchcriteria Advanced search criteria for accounts. Date values must be in yyyy-MM-dd format, and booleans are exact matches.
type ExportAccountRequestAdvsearchcriteria struct {
	...
	Accountowner []ExportAccountRequestAdvsearchcriteriaAccountownerInner `json:"accountowner,omitempty"`
}
...
func NewExportAccountRequestAdvsearchcriteria() *ExportAccountRequestAdvsearchcriteria {
	this := ExportAccountRequestAdvsearchcriteria{}
	return &this
}
...
func (o *ExportAccountRequestAdvsearchcriteria) GetAccountowner() []ExportAccountRequestAdvsearchcriteriaAccountownerInner {
	if o == nil || IsNil(o.Accountowner) {
		var ret []ExportAccountRequestAdvsearchcriteriaAccountownerInner
		return ret
	}
...
// SetAccountowner gets a reference to the given []ExportAccountRequestAdvsearchcriteriaAccountownerInner and assigns it to the Accountowner field.
func (o *ExportAccountRequestAdvsearchcriteria) SetAccountowner(v []ExportAccountRequestAdvsearchcriteriaAccountownerInner) {
	o.Accountowner = v
}

func (o ExportAccountRequestAdvsearchcriteria) MarshalJSON() ([]byte, error) {
...
func (o ExportAccountRequestAdvsearchcriteria) ToMap() (map[string]interface{}, error) {
...
type NullableExportAccountRequestAdvsearchcriteria struct {
	value *ExportAccountRequestAdvsearchcriteria
	isSet bool
}

func (v NullableExportAccountRequestAdvsearchcriteria) Get() *ExportAccountRequestAdvsearchcriteria {
	return v.value
}

func (v *NullableExportAccountRequestAdvsearchcriteria) Set(val *ExportAccountRequestAdvsearchcriteria) {
	v.value = val
	v.isSet = true
}

func (v NullableExportAccountRequestAdvsearchcriteria) IsSet() bool {
	return v.isSet
}

func (v *NullableExportAccountRequestAdvsearchcriteria) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExportAccountRequestAdvsearchcriteria(val *ExportAccountRequestAdvsearchcriteria) *NullableExportAccountRequestAdvsearchcriteria {
	return &NullableExportAccountRequestAdvsearchcriteria{value: val, isSet: true}
}

func (v NullableExportAccountRequestAdvsearchcriteria) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExportAccountRequestAdvsearchcriteria) UnmarshalJSON(src []byte) error {
	v.isSet = true
