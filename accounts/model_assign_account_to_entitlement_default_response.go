...
// checks if the AssignAccountToEntitlementDefaultResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssignAccountToEntitlementDefaultResponse{}

// AssignAccountToEntitlementDefaultResponse struct for AssignAccountToEntitlementDefaultResponse
type AssignAccountToEntitlementDefaultResponse struct {
...
func NewAssignAccountToEntitlementDefaultResponse() *AssignAccountToEntitlementDefaultResponse {
	this := AssignAccountToEntitlementDefaultResponse{}
	return &this
}
...
func (o AssignAccountToEntitlementDefaultResponse) MarshalJSON() ([]byte, error) {
...
func (o AssignAccountToEntitlementDefaultResponse) ToMap() (map[string]interface{}, error) {
...
type NullableAssignAccountToEntitlementDefaultResponse struct {
	value *AssignAccountToEntitlementDefaultResponse
	isSet bool
}

func (v NullableAssignAccountToEntitlementDefaultResponse) Get() *AssignAccountToEntitlementDefaultResponse {
	return v.value
}

func (v *NullableAssignAccountToEntitlementDefaultResponse) Set(val *AssignAccountToEntitlementDefaultResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAssignAccountToEntitlementDefaultResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAssignAccountToEntitlementDefaultResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAssignAccountToEntitlementDefaultResponse(val *AssignAccountToEntitlementDefaultResponse) *NullableAssignAccountToEntitlementDefaultResponse {
	return &NullableAssignAccountToEntitlementDefaultResponse{value: val, isSet: true}
}

func (v NullableAssignAccountToEntitlementDefaultResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAssignAccountToEntitlementDefaultResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
