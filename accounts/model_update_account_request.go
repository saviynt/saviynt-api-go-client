...
type UpdateAccountRequest struct {
	...
	// Username of the user updating the account.
	Updateuser *string `json:"updateuser,omitempty"`
	// Account status, e.g., Manually Suspended, Manually Provisioned, SUSPENDED FROM IMPORT SERVICE, or numeric values like 1, 2, 3, 4 (default: 1).
	Status *string `json:"status,omitempty"`
	// The account type imported from a third-party system, e.g., Service Account, Shared Account, FIREFIGHTERID.
	...
	// List of account owner objects. Each object must include type, value, and action; rank is optional (default: '1').
	Accountowner []UpdateAccountRequestAccountownerInner `json:"accountowner,omitempty"`
}
...
func (o *UpdateAccountRequest) GetAccountowner() []UpdateAccountRequestAccountownerInner {
	if o == nil || IsNil(o.Accountowner) {
		var ret []UpdateAccountRequestAccountownerInner
		return ret
	}
...
// SetAccountowner gets a reference to the given []UpdateAccountRequestAccountownerInner and assigns it to the Accountowner field.
