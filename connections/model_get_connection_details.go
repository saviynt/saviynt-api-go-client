...
type GetConnectionDetails struct {
	...
	Connectionattributes *GetConnectionDetailsConnectionattributes `json:"connectionattributes,omitempty"`
}
...
func (o *GetConnectionDetails) GetConnectionattributes() GetConnectionDetailsConnectionattributes {
	if o == nil || IsNil(o.Connectionattributes) {
		var ret GetConnectionDetailsConnectionattributes
		return ret
	}
...
// SetConnectionattributes gets a reference to the given GetConnectionDetailsConnectionattributes and assigns it to the Connectionattributes field.
