...
// checks if the UpdateOrganizationRequestEndpointsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateOrganizationRequestEndpointsInner{}

// UpdateOrganizationRequestEndpointsInner struct for UpdateOrganizationRequestEndpointsInner
type UpdateOrganizationRequestEndpointsInner struct {
...
func NewUpdateOrganizationRequestEndpointsInner() *UpdateOrganizationRequestEndpointsInner {
	this := UpdateOrganizationRequestEndpointsInner{}
	return &this
}
...
func (o *UpdateOrganizationRequestEndpointsInner) SetEndpointname(v string) {
	o.Endpointname = &v
}
...
func (o UpdateOrganizationRequestEndpointsInner) MarshalJSON() ([]byte, error) {
...
func (o UpdateOrganizationRequestEndpointsInner) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateOrganizationRequestEndpointsInner struct {
	value *UpdateOrganizationRequestEndpointsInner
	isSet bool
}

func (v NullableUpdateOrganizationRequestEndpointsInner) Get() *UpdateOrganizationRequestEndpointsInner {
	return v.value
}

func (v *NullableUpdateOrganizationRequestEndpointsInner) Set(val *UpdateOrganizationRequestEndpointsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateOrganizationRequestEndpointsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateOrganizationRequestEndpointsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateOrganizationRequestEndpointsInner(val *UpdateOrganizationRequestEndpointsInner) *NullableUpdateOrganizationRequestEndpointsInner {
	return &NullableUpdateOrganizationRequestEndpointsInner{value: val, isSet: true}
}

func (v NullableUpdateOrganizationRequestEndpointsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateOrganizationRequestEndpointsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
